...
public class Estacion {
    ...
    public String getDatos(String fecha) {
        return this.fecha + " " + this.sensores[0].getRegistroFecha(fecha)
                + " " + this.sensores[1].getRegistroFecha(fecha) + " "
                + this.sensores[2].getRegistroFecha(fecha) + " ";
    }
    ...
    public String ToStringProm() {
        String s = "Promedios ";
        s += this.promedioTemp() + " " + this.promedioAgua()
                + " " + this.promedioCarga();
        return s;
    }
